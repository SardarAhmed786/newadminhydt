...
export default function TopRefByCommision() {
  ...
  function getTopRefByEarnComFunc() {
    ...
    axios
      .get(Envirnoment.apiUrl + "users/get-admin-top-refferals-by-commission", {
        headers: {
          ...
          return (
            <div className="parenthead">
              <div className="inner">
                ...
                <h4>
                  {parseFloat(item?.totalRewardAmount || 0)?.toFixed(4) || 0}
                </h4>
              </div>
            </div>
          );
      ...
      <div className="pagi">
        ...
        <div className="right">
          <div className="arrows">
            <img
              onClick={() => (offset > 1 ? setOffset(offset - 1) : null)}
              src="\assests\pagi.svg"
              alt="1mg"
              className={offset > 1 ? "img-fluid cp" : "img-fluid disable"}
            />
          </div>
          <Pagination>
          ...
          <div className="arrows">
            <img
              onClick={() =>
                offset < data?.pages ? setOffset(offset + 1) : null
              }
              src="\assests\pagiright.svg"
              alt="1mg"
              className={
                offset < data?.pages ? "img-fluid cp" : "img-fluid disable"
              }
            />
          </div>
        </div>
