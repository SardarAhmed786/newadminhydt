            ...
            {activeTab === "link-2" && (
              <>
                ...
                <div className="maininput">
                  <input
                    onChange={(e) => setHygtCommisionRates(e.target.value)}
                    value={hygtComRate}
                    type="text"
                ...
                <button onClick={updateHygtComRate} className="save">
                  Save
                </button>
              </>
            )}
          ...
          <Modal.Body>
            <div className="main">
              ...
              <input
                ...
                onChange={(e) => {
                  setLevelData({ ...levelData, value: e.target.value });
                }}
                type="text"
                placeholder={levelData?.value + "%"}
              />
            </div>
